    ...
    <v-layout row wrap>
      <v-flex xs12>
        <v-dialog
          ...
          width="290px"
        >
          <v-date-picker color="pink" v-model="selectedTask.deadline" scrollable>
            <v-spacer></v-spacer>
            <v-btn flat color="pink" @click="dialog = false">OK</v-btn>
          </v-date-picker>
        </v-dialog>
        <v-card>
          ...
          <v-container>
            ...
            <v-form ref="form" v-model="valid" lazy-validation>
              ...
              ></v-text-field>
              <v-container>
                <v-btn block :disabled="!valid" class="pink white--text" @click="add">
